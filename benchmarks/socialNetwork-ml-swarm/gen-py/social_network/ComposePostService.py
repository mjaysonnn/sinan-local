...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap = {
            ...
            "UploadMedia": Processor.process_UploadMedia,
            "UploadUniqueId": Processor.process_UploadUniqueId,
            "UploadCreator": Processor.process_UploadCreator,
            "UploadUrls": Processor.process_UploadUrls,
            "UploadUserMentions": Processor.process_UploadUserMentions,
        }
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i106 in range(_size102):
                        ...
                        _val108 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
